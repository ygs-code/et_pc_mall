                    ...
                    <div class="acea-row row-top" style="position: relative">
                        <div class="carousel">
                            <div class="preview" :style="{
                                'background-image': `url(${JSON.parse(productInfo.sliderImage)[slideIndex]
                                    }`,
                            }"></div>
                            <client-only>
                            ...
                            )" :key="index" :class="{ on: slideIndex === index }" class="swiper-slide"
                    ...
                    <div class="btn" style="width: 60px" @click="collect">
                      ...
                      >{{
                        ...
                        <div class="text-wrapper">
                            ...
                            <div class="storeinfo-wrap" v-if="productInfo">
                                <div class="info-item" v-for="(item, index) in productInfo.storeInfoList" :key="index">
                                    <i class="s-dot"></i>
                                    <span>{{ item }}</span>
                                </div>
                            </div>
                            ...
                            <div v-if="guaranteeList.length" class="number-wrapper acea-row guaranteeList">
                                <div class="label" @mouseover="guaranteeTitle = true"
                                    ...
                                    <span class="iconfont icon-duoshanghupc-shuomingdanchuang"></span>
                                </div>
                                <div class="guaranee_tel" :style="{
...
<div v-if="replyList.length" class="acea-row row-right">
    <el-pagination layout="prev, pager, next" :page-size="reply.limit" :total="replyCount"
        @current-change="callPaginate" @prev-click="callPaginate" @next-click="callPaginate"></el-pagination>
</div>
</div> -->
                        </div>
...
export default {
    ...
    async asyncData({ error, app, params, query }) {
        try {
            ...
            console.log(" goods.data.productInfo==", goods.data.productInfo);
            goods.data.productInfo.storeInfoList = goods.data.productInfo.storeInfo.split('\n')
