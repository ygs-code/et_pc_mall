        ...
        >
                ...
                <div class="content" @click="goDetail(itemn)">
                  ...
                  >
                    ...
                    <div class="info-price">
                      <div class="price">
                        {{ GLOBAL.shopPayCurrency }} {{ goods.price }}
                      </div>
          ...
          <div class="foot">
            <p>
              ...
              <span class="price"
                >{{ GLOBAL.shopPayCurrency }}{{ itemn.payPrice }}
              </span>
            </p>
            <div class="btn-wrapper">
              ...
              <div class="pay" v-if="!itemn.paid" @click="goPays(itemn)">
                {{ $t(`page.users.orderList.pay`) }}
              </div>
              <div
                class="pay"
                v-else-if="
                  itemn.status == 0 || itemn.status == 1 || itemn.status == 3
                "
